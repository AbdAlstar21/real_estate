...
// List<RealtyData>? realtyListold;

class RealtyOld extends StatefulWidget {
  @override
  _RealtyOldState createState() => _RealtyOldState();
}

class _RealtyOldState extends State<RealtyOld> {
  ...
  void getDataRealty(int count, String strSearch) async {
    loadingList = true;
    setState(() {});
    List arr = await getData(count, "realtys/readrealty_user_old.php", strSearch,
