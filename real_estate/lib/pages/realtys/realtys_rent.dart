...
class RealtyPay extends StatefulWidget {
  @override
  _RealtyPayState createState() => _RealtyPayState();
}

class _RealtyPayState extends State<RealtyPay> {
  ...
  void getDataRealty(int count, String strSearch) async {
    loadingList = true;
    setState(() {});
    List arr = await getData(count, "realtys/readrealty_rent.php", strSearch,
