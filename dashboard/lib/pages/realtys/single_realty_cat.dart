...
class SingleRealtyCat extends StatefulWidget {
  int realty_index;
  RealtysData realtys;
  SingleRealtyCat({Key? key, required this.realty_index, required this.realtys})
      : super(key: key);

  @override
  State<SingleRealtyCat> createState() => _SingleRealtyCatState();
}

class _SingleRealtyCatState extends State<SingleRealtyCat> {
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          // realtyList!.removeAt(widget.realty_index);
                          // deleteData("realty_id", widget.realtys.realty_id,
                          //     "realtys/delete_realty.php");
                          // providerRealty.add_loading();
                        },
                        child: Container(
                          margin: const EdgeInsets.only(bottom: 5),
                          padding: const EdgeInsets.all(4),
